...
use actix_web::web;
use crate::handlers::{user_handlers, project_handlers, auth_handlers, admin_handlers, report_handlers, issue_handlers};
...
fn init_issue_routes(cfg: &mut web::ServiceConfig) {
    cfg.service(
        web::scope("/issue")
            ...
            .service(issue_handlers::get_issues_handler)
    );
}
